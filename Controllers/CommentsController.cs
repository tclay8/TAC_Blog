...
namespace TAC_Blog.Controllers
{
    ...
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,BlogId,Body")] Comment comment)
        {
            if (ModelState.IsValid)
            {
                ...
                var returnSlug = db.Posts.Find(comment.BlogId).Slug;
                db.Comments.Add(comment);
                db.SaveChanges();
                return RedirectToAction("Details", "BlogPosts", new { Slug = returnSlug });
            }

            ViewBag.AuthorId = new SelectList(db.Users, "Id", "FirstName", comment.AuthorId);
            ViewBag.BlogId = new SelectList(db.Posts, "Id", "Title", comment.BlogId);
            return View(comment);
        }
